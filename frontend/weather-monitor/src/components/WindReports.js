...
const WindReports = () => {
  ...
  return (
    <div className={styles.container}>
      <h2 className={styles.title}>Saved Wind Energy Reports</h2>
        ...
        <ul className={styles.detailsContainer}>
          {savedReports.map((report, index) => (
            <li key={index} className={styles.inputContainer}>
              ...
              <div><strong>Number of turbines:</strong> {report.turbineCount}</div>
              ...
              >
                {report.showDetails ? "Hide Details" : "View Briefly"}
              </button>
                  ...
                  <ul className={styles.table}>
                    ...
                    {report.energyProduction.map((energy, idx) => (
                      <li key={idx} className={styles.table}>
                        ...
                        <div><strong>Wind Speed:</strong> {energy.windSpeed} m/s</div>
